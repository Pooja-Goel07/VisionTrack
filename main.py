...
import cv2                     # OpenCV for image/video
import cvzone                  ### For fancy bounding boxes & text
import math                    # For rounding confidence
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            cvzone.cornerRect(img, (x1, y1, w, h))   #note: cvzone is used here

            #confidence 
            conf = math.ceil((box.conf[0]*100))/100  #upto 2 decimal place
